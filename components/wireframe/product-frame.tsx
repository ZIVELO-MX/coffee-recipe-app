  ...
  return (
    <RecipeOverlayContext.Provider value={setSelectedRecipe}>
      <main className="flex min-h-screen justify-center bg-background">
        <div className="relative flex h-[100dvh] w-full max-w-[400px] flex-col overflow-hidden bg-background [padding-top:env(safe-area-inset-top)] sm:my-4 sm:h-[calc(100dvh-2rem)] sm:rounded-[2.5rem] sm:border sm:border-border sm:shadow-2xl sm:pt-0">
